...
@hydra.main(version_base=None, config_path='conf', config_name='train_config_ADRIL_dubins')
...
def train(cfg: DictConfig, file_prefix: str='') -> float:
  ...
  for step in pbar:
    ...
    if step >= cfg.training.start and step % cfg.training.interval == 0:
      ...
      if cfg.imitation.mix_expert_data == 'mixed_batch' and cfg.algorithm != 'AdRIL': 
